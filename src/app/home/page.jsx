  ...
  return (
    <div className="bg-[url('/images/fondo_recetas.png')] bg-cover bg-center h-screen text-white">
      <div className="grid grid-cols-2 w-full h-screen max-md:grid-cols-1">
        ...
        <section className="flex flex-col gap-10 justify-center items-center h-full max-md:pr-20 max-md:pl-64 max-md:h-[80vh] max-sm:pr-0 max-sm:pl-24 max-sm:mr-7">
